...
class RtTemplateService(
    ...
    private val blockDefinitions = linkedMapOf(
        ...
        JORNADA_TRABALHO_TURNOS_ININTERRUPTOS_REVEZAMENTO to RtBlockDefinition(
            titulo = { "d. Turnos ininterruptos de revezamento" },
        ...
        JORNADA_TRABALHO_SOBREAVISO to RtBlockDefinition(
            titulo = { "g. Sobreaviso" },
    ...
    private fun jornadaTrabalhoSobreaviso(variaveis: Map<String, String?>): String =
        JORNADA_TRABALHO_SOBREAVISO_TEMPLATE.replace(
...
**O trabalho prestado em domingos e feriados, não compensado, deve ser pago em dobro**, sem prejuízo da remuneração relativa ao repouso semanal."""
        ...
        private val JORNADA_TRABALHO_SOBREAVISO_TEMPLATE = listOf(
            "A parte autora era chamada ao trabalho após o encerramento de sua jornada regular, {descricaoChamadosSobreaviso}.",
            "A parte autora permanecia em **regime de sobreaviso**, uma vez que era acionada em qualquer horário pela ré, não podendo sair da sua residência/cidade, pois precisava atender aos chamados da ré **imediatamente**.",
            "Assim, a conduta da ré limitava o direito de locomoção da parte autora, uma vez que precisava estar sempre à disposição caso a ré lhe acionasse, em afronta ao **art. 7º, XIII, da Constituição Federal**.",
            SOBREAVISO_JURISPRUDENCIA,
            "O **§ 2º do art. 244 da CLT** dispõe que *Considera-se de \"sobre-aviso\" o empregado efetivo, que* ***permanecer em sua própria casa, aguardando a qualquer momento o chamado para o serviço****. Cada escala de \"sobre-aviso\" será, no máximo, de vinte e quatro horas, As horas de \"sobre-aviso\", para todos os efeitos, serão contadas à razão de 1/3 (um terço) do salário normal.*",
            "Pelo exposto, **REQUER** seja a parte ré condenada ao pagamento das horas a título de sobreaviso, com base no salário mensal integral, bem como seus reflexos em RSR e, com estes, em férias + 1/3, 13º salários, FGTS + multa de 40%, aviso prévio, horas extras, adicional noturno e adicional de periculosidade."
        ).joinToString("\n\n")
        private const val SOBREAVISO_JURISPRUDENCIA = """Tal cenário configura sobreaviso, conforme **Súmula 428 do TST**:
